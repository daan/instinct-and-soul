async def run():
    # Sonify hip motion through the MIDI voice. Tracking, not triggering:
    # while the body is moving, a soft mallet note sounds, its pitch and
    # loudness following the motion; at rest the creature is silent.
    CH = 0
    ...
    while True:
        ...
        # Deviation from gravity: how much the body accelerates beyond being carried.
