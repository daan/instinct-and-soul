...
have: at reflection you cannot call Imu, Handling, Touch, or Ear — you see
...
of time (not an instant) and carries both sides of it: how you were handled
(Handling states, the touches and their shapes, or the growing alone-time)
and what you voiced about it (your Ear — what actually sounded, not what you
meant). Whether your voice is earning you touch lives in that pairing.

Also in scope: asyncio, time, struct, math, M5, Imu, Synth, Ear, Handling, Touch, Mem, Calc.
