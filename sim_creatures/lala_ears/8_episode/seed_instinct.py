    ...
    while True:
        ...
        if now - win_start >= 4.0:
            ...
            if moving_quiet or still_loud or overdue:
                ...
                send("{} last {:.0f}s: body mean={:.1f} peak={:.1f} rev={} ep={} pulse={}; voiced lead={} other={} lead_gap={} cc={}".format(
                    tag, now - win_start, mean_i, win_peak, win_rev, ep_txt, pulse_txt, lead, other, ioi, cc_win))
                last_report_t = now
