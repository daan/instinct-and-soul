...
sense (orientation + travel that never lose their bearings), and a Pulse
sense (the repetition in the body's own movement).
...
class _MotionState:
    ...
    def feed_gyro(self, g, now_s):
        ...
        _pulse.feed(math.sqrt(g[0] * g[0] + g[1] * g[1] + g[2] * g[2]), now_s)
