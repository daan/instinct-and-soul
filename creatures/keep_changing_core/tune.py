"""
tune.py — interactive tuner for the keep_changing_core creature (CORES3 hardware).

Run:
    tune creatures/keep_changing_core

Then flash creatures/keep_changing_core/main.py onto the CORES3 (set STA_SSID/PASS first)
...
class KeepChangingCoreTuner(TuneAppBase):
    INITIAL_INSTINCT = INSTINCT_IDLE
    STATUS_LABEL = "keep_changing_core"
