...
# ── Persistent memory ──────────────────────────────────────────────────────
# Bounded named-slot ring buffers that survive instinct hot-swap. Local
# variables in the soul's run() coroutine are wiped each time the instinct
# is rewritten; Mem lives at module scope, so it persists.
