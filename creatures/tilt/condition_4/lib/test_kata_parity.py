...
from kata_sense import make_kata_sense
...
def run_profile(segments, grav_fn=None):
    """segments: list of (duration_s, speed01). Returns (events, sense_step)."""
    events = []
    step = make_kata_sense(Calc, lambda kind, **kw: events.append((kind, kw)))
    t = 0.0
