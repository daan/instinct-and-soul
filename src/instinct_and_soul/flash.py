...
WIFI_PY_TEMPLATE = (
    "# Generated by `flash wifi {profile}`. Edit networks/{profile}.toml, not this file.\n"
    "MODE = {mode!r}\n"
    "AP_SSID = {ap_ssid!r}\n"
    "AP_PASS = {ap_pass!r}\n"
...
def flash_wifi(argv):
    parser = argparse.ArgumentParser(
        prog="flash wifi",
        description="Flash a wifi.py rendered from networks/<profile>.toml")
    parser.add_argument("profile",
                        help="Profile name (file in networks/, without .toml)")
    parser.add_argument("--port", default=None,
                        help="Serial port (auto-detected if omitted)")
    args = parser.parse_args(argv)
...
def list_wifi(argv):
    parser = argparse.ArgumentParser(
        ...
        description="List network profiles in networks/")
